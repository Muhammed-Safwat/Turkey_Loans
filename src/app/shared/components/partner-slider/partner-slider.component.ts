  ...
  readonly partners: Partner[] = [
    {
      id: 1,
      name: 'بنك الراجحي',
      logo: '/images/logo/media_03.svg',
      alt: 'بنك الراجحي'
    },
    {
      id: 2,
      name: 'البنك الأهلي السعودي',
      logo: '/images/logo/media_04.svg',
      alt: 'البنك الأهلي السعودي'
    },
    {
      id: 3,
      name: 'بنك البلاد',
      logo: '/images/logo/media_01.svg',
      alt: 'بنك البلاد'
    },
    {
      id: 4,
      name: 'شركة تمويل الأهلي',
      logo: '/images/logo/media_07.svg',
      alt: 'شركة تمويل الأهلي'
    },
    {
      id: 5,
      name: 'شركة تمويل الأهلي',
      logo: '/images/logo/media_08.svg',
      alt: 'شركة تمويل الأهلي'
    },
    {
      id: 6,
      name: 'شركة ساب للتمويل',
      logo: '/images/logo/media_02.svg',
