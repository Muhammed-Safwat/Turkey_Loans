  ...
  readonly features: Feature[] = [
    {
      ...
      description:
        "نقدم لك التوجيه الصحيح لاختيار الحل الأنسب لك مع أقل هامش ربح وبطريقة شرعية.",
      link: "/services",
      delay: "0s",
    },
    {
      ...
      title: "سرية وأمان",
      description:
        "نضمن لك سرعة إنجاز معاملاتك بسرية تامة وحماية كاملة لبياناتك.",
      link: "/services",
      isActive: true,
      delay: "0.1s",
    },
    {
      ...
      description:
        "نساعدك في سداد المتعثرات وإعادة ترتيب التزاماتك المالية بما يناسب دخلك.",
      link: "/services",
      delay: "0.2s",
    },
  ];
